...
//        viewModel.currencyClosure = {
//            self.resultLabel.text = self.viewModel.outputDollar
//        }
        viewModel.outputDollar.bind { _ in
            self.resultLabel.text = self.viewModel.outputDollar.value
